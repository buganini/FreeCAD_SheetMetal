...
def smFold(fp, bendR=0.8, bendA=90.0, kfactor=1, invertbend=False, flipped=False, unfold=False,
           position="forward", bendlinesketch=None, selFaceNames="", MainObject=None, attachedObjects=None):
